...
if(isset($_POST['new']) && $_POST['new']==1){
    ...
    $ins_query="INSERT INTO `Nodes` (`id`, `title`, `Description`) VALUES (NULL, '$title', '$Nodes');";
...
<html lang="en">
  ...
  <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="add_Node.php">add New Node</a>
      </li>
...
<div>
<h1>Insert New Node</h1>
<form name="form" method="post" action=""> 
<input type="hidden" name="new" value="1" />
<p><input type="text" name="title" placeholder="Enter Title" required /></p>
<p><textarea name="Nodes" id="Nodes" rows="10" cols="100">Enter your Nodes here...</textarea></p>
